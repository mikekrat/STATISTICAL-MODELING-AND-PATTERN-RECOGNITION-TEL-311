...
mr1 = meas_reduced(iris_labels == 0, :);
mr2 = meas_reduced(iris_labels == 1, :);
mr3 = meas_reduced(iris_labels == 2, :);
...
[meas_norm_rec] = recoverDataLDA(meas_reduced, v);

mr1_rec = meas_norm_rec(iris_labels == 0, :);
mr2_rec = meas_norm_rec(iris_labels == 1, :);
mr3_rec = meas_norm_rec(iris_labels == 2, :);

figure(5)
hold on
plot(mr1_rec(:, 1), mr1_rec(:, 2), 'bo')
plot(mr2_rec(:, 1), mr2_rec(:, 2), 'rs')
plot(mr3_rec(:, 1), mr3_rec(:, 2), 'g+')
hold off
